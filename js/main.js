$(window).ready(function() {
  ...
  Promise.all([
    ...
    d3.csv('assets/weather_tab/detroit_lake_gridmet_2012_01_01_2021_11_27.csv'), //datasets[27]
...
$("#donut-chart > svg > g:nth-child(2) > g.c3-chart > g.c3-chart-arcs > text").text(100*model_accuracy[d.index]+"% Observed Bloom area");
  ...
  // var monthDonut = getMonth(USTdDonut);
  // var dayDonut = getDay(USTdDonut);
  // var yearDonut = getYear(USTdDonut);
$("#dateCyan").text(USTdDonut);
donutChart.load({
    unload: true,
    columns:[
      ['Probability of a bloom', cyanoProb],
